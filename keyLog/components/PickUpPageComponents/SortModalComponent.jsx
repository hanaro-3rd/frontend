        ...
        >
          ...
          >
            ...
            <View style={{ paddingTop: 20 }}>
              ...
              >
                <Text style={sortModal[0]=="distance"&&{color:"#55ACEE"}}>거리순</Text>
                {sortModal[0]=="distance"&&<Image source={require("../../assets/Setting/check.png")} />}
              </TouchableOpacity>
              <TouchableOpacity
                style={{
                  flexDirection: "row",
              ...
              >
                <Text style={sortModal[0]=="amount"&&{color:"#55ACEE"}}>금액순</Text>
                {sortModal[0]=="amount"&&<Image source={require("../../assets/Setting/check.png")} />}
              </TouchableOpacity>
              <TouchableOpacity
                style={{
                  flexDirection: "row",
              ...
              >
                <Text style={sortModal[0]=="limitAmount"&&{color:"#55ACEE"}}>남은 인원순</Text>
                {sortModal[0]=="limitAmount"&&<Image source={require("../../assets/Setting/check.png")} />}
              </TouchableOpacity>
            </View>
            <TouchableOpacity
              style={{
