      ...
      <View style={styles.body}>
        ...
        <View style={styles.bodyMain}>
          <View style={styles.menuCarousel}>
            ...
            <View style={styles.carouselCard3}>
            </View>
          </View>
              ...
              <View style={styles.textContainer}>
                <View style={styles.countryContainer}>
                  <View style={styles.textContainer2}>
                    ...
                    <Text style={styles.monetaryUnit}>
                      USD
                    </Text>
                  </View>
            ...
            <Image source={MenuIcon6}/>
              <View style={styles.menuContainer7}>
                <View style={styles.menuTextContainer6}>
                  <Text style={styles.menuTitle6}>
                    계좌 연결하기
                  </Text>
                  <Text style={styles.menuSubtitle6}>
                    계좌를 연결해보아용
                  </Text>
                </View>
                <View style={styles.menuButton6}>
                  <Text style={styles.buttonText7}>
                    연결하러 가기
                  </Text>
                </View>
              </View>
